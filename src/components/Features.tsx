        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 h-96 flex items-center justify-center">
                <img 
                  src="/lovable-uploads/d79f94ad-c391-4218-b0f2-de19e19b3b37.png" 
                  alt="Metallic liquid design"
